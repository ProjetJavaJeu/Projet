...
public class InterfaceCombat extends JFrame {
	...
	public InterfaceCombat(Player one, Player monster) throws SlickException {
		...
		if (one.perso.getType() == 'G'){
			playerLabel.setIcon(new ImageIcon("src/main/ressources/imagesCombat/warrior.jpg"));
		}
		else 
			playerLabel.setIcon(new ImageIcon("src/main/ressources/imagesCombat/mage2.jpg"));
		...
		if (monster.perso.getType() == '1'){
			enemyLabel.setIcon(new ImageIcon("src/main/ressources/imagesCombat/orc2.jpg"));
		}
		else if (monster.perso.getType() == '2'){
			enemyLabel.setIcon(new ImageIcon("src/main/ressources/imagesCombat/murloc.jpg"));
		}
