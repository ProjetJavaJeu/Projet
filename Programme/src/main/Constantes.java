...
public class Constantes {
	...
	public final static int CARTE_JEU = 3;				//Valeur d'état de jeu pouyr passer  à la carte.
	public final static String NOM_JEU = "The Epic School Adventure";
	public final static float LARGEUR_BOUTTON = 150;
	public final static float HAUTEUR_BOUTTON = 35;
